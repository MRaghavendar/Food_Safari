...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mAwesomeValidation.addValidation(emailet, android.util.Patterns.EMAIL_ADDRESS,
            ...
            public void onClick(View v) {
                {
                    ...
                    dialog.setMessage("Deleting this account will completely removes your account" +
                            " and you won't be able to access this app");
